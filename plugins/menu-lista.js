...
title: "YALLICO FUNCIONES",
description: "Infórmate por medios oficiales sobre YallicoBot",
sections: [
{ title: "ℹ️ Información", highlight_label: "Popular",
rows: [
{ header: "✅ Redes", title: "🔓 Para: Todos", description: "Infórmate por medios oficiales sobre YallicoBot", id: usedPrefix + "cuentasgb" },
{ header: "📢 Grupos/Canales", title: "🔓 Para: Todos", description: "¡Te esperamos!", id: usedPrefix + "grupos" },
{ header: "🎁 Donar", title: "🔓 Para: Todos", description: "YallicoBot se mantiene funcionando gracias a donaciones ¡tú también puedes sumarte apoyando el proyecto!", id: usedPrefix + "donar" }
{ header: "🚄 Velocidad", title: "🔓 Para: Todos", description: "Seleccione esto si desea saber el ping del Bot", id: usedPrefix + "ping" },
{ header: "😺 Estado", title: "🔓 Para: Todos", description: "Conoce en que estado se encuentra YallicoBot", id: usedPrefix + "estado" }
]},
{ title: "🔖 Comprar Yallico", highlight_label: "Popular",
rows: [
{ header: "🇦🇱 ComprarBot", title: "🔓 Para: Todos", description: "presiona si deseas comprar a Yallico", id: usedPrefix + "ComprarBot" },
{ header: "🇵🇪 ServerBot", title: "🔓 Para: Todos", description: "Averigua Dónde Esta Hosteado Yallico Bot", id: usedPrefix + "ServerBot" },
]},
...
┃
┃✅ *_CUENTAS OFICIALES YALLICOBOT_* ✅
┃➺ _${usedPrefix}cuentasgb_
┃
*╰━━━━━━━━━━━━━⬣*`.trim()
await conn.sendFile(m.chat, gataImg, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝘠𝘢𝘭𝘭𝘪𝘤𝘰 𝘝𝘦𝘯𝘵𝘢𝘴 𝘉𝘰𝘵 🇦🇱', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
